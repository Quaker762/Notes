...
public class CutMenuListener implements ActionListener {
	public void actionPerformed(ActionEvent e) 
	{
		...
		NotesFrame.textArea.replaceRange("", NotesFrame.textArea.getSelectionStart(), NotesFrame.textArea.getSelectionEnd());
	}
